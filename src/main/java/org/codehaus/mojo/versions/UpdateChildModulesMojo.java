        ...
        try {
            ...
            for (String sourcePath : order) {
                ...
                synchronized (this) {
                    ...
                    getLog().debug("Looking for modules which use " + ArtifactUtils.versionlessKey(sourceGroupId, sourceArtifactId)
                    ...
                    for (Map.Entry<String, Model> target : PomHelper.getChildModels(reactor, sourceGroupId, sourceArtifactId).entrySet()) {
                        ...
                        if (sourceVersion.equals(parent.getVersion())) {
                            getLog().debug("Module: " + targetPath + " parent is " + ArtifactUtils.versionlessKey(sourceGroupId, sourceArtifactId) + ":"
                                    + sourceVersion);
                        } else {
                            ...
                            getLog().info("    updated to " + ArtifactUtils.versionlessKey(sourceGroupId, sourceArtifactId) + ":" + sourceVersion);
